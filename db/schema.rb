...
ActiveRecord::Schema[7.0].define(version: 20_220_905_225_534) do
  ...
  create_table 'likes', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.bigint 'comment_id'
    t.index %w[author_id post_id], name: 'index_likes_on_author_id_and_post_id', unique: true
  ...
  create_table 'reports', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[author_id post_id comment_id], name: 'index_reports_on_author_id_and_post_id_and_comment_id',
                                              unique: true
