...
ActiveRecord::Schema[7.0].define(version: 20_220_910_220_830) do
  ...
  create_table 'likes', force: :cascade do |t|
    ...
    t.index %w[author_id likeable_id likeable_type],
            name: 'index_likes_on_author_id_and_likeable_id_and_likeable_type', unique: true
  ...
  create_table 'reports', force: :cascade do |t|
    ...
    t.index %w[author_id reportable_id reportable_type], name: 'author_and_reportable_index', unique: true
    t.index ['author_id'], name: 'index_reports_on_author_id'
    t.index %w[reportable_id reportable_type], name: 'index_reports_on_reportable_id_and_reportable_type'
